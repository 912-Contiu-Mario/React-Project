...
const UpdateModule = ({ moduleType }) => {
    ...
    const updateModuleHandler = useContext(AppContext).handleUpdateModule;
    ...
    const handleChange = (field, e) => {
        ...
        if (field == 'loadLimit') {
            ...
            else if (e.target.value > 10000 || e.target.value < 0) {
                setHorsepower(e.target.value);
                isValid = false;
                errorMessage = 'Maximum horsepower is 10000 HP';
            }
            else {
                setHorsepower(e.target.value);
                isValid = true;
            ...
            if (!/^\d+$/.test(e.target.value) && e.target.value != '') {
                ...
                isValid = false;
                errorMessage = 'Weight should be in the range 0-100000 kg';
